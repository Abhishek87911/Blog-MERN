...
export default function DashboardComponent() {
    ...
    const [ totalComments, setToatalComments ] = useState(0);
    const [ totalPosts, setToatalPosts ] = useState(0);
    ...
    useEffect(() => {
        const fetchUsers = async () => {
           try {
            ...
            if(res.ok) {
                ...
                setToatalUsers(data.totalUsers);
        ...
        const fetchPosts = async () => {
            try {
                ...
                if(res.ok) {
                    setPosts(data.posts);
                    setToatalPosts(data.totalPosts);
        ...
        const fetchComments = async () => {
            try {
                ...
                if(res.ok) {
                    ...
                    setToatalComments(data.totalComments);
       ...
       <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
        <div className="flex justify-between">
            ...
            <div className="flex gap-2 text-sm ">
                ...
                <span className="text-gray-500">Last Months</span>
            </div>
      </div>
      <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
        <div className="flex justify-between">
